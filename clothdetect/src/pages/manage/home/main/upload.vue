<template>
  <div class="myBiaoZhu" id="myBiaoZhuDiv" v-loading="loading" element-loading-text="视频解析中"
      ...
      <div class="upload-element uploadDiv" v-if="show">
        <el-form :model="ruleForm" ref="ruleForm" label-width="100px">
          <el-form-item label="上传视频:" ref="uploadElement" required prop="video">
            ...
            <el-upload class="avatar-uploader" style="float: left" ref="upload" :show-file-list="false" action="#"
              :before-upload="beforeUpload" :on-change="handleChange" :auto-upload="false" accept="video/*"
              :data="ruleForm">
            ...
            <video controls aspectRatio="16:9" fluid ref="video" :style="{ 'display': isShow }">
            </video>
          </el-form-item>
