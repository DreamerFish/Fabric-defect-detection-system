<template>
  <div class="register">
    <div class="nav">
      <div class="inner">
        <div @click="$router.push({ name: 'login' })" class="logo">
          <span>海创-臂上眼</span>
        </div>
      </div>
    </div>
    <div class="registerDiv">
      <div class="find">
        ...
        <div class="info" v-show="active == 0">
          ...
          <div class="inputRow">
            <el-button type="primary" @click="toTwo">下一步</el-button>
          </div>
          <div class="inputRow">
        ...
        <div class="info" v-show="active == 3">
          <div class="inputRow">
            <span class="registerSuccess"
              ><i class="el-icon-success"></i>恭喜您，注册成功</span
            >
          </div>
